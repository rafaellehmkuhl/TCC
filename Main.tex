...
\membrob{Prof. Dr. Henrique Simas}   % Professor membro da banca
\membroc{Prof. Dr. Rodrigo de Souza Vieira}   % Professor membro da banca
...
\DEELepigrafe{\textit{"Essa pica não é mais minha, essa pica agora é do Samuel."} \\ (FÁBIO, Capitão)}
